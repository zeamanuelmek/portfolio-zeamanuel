...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      'Enhancing an iOS task management app with intuitive task flows, team collaboration features, and effective communication — focusing on iOS-native design patterns and design system consistency.',
    thumbnail: '/images/dh-thumb.jpg',
    category: 'mobile-app',
    tags: ['iOS Design', 'UI Design', 'Task Management', 'Collaboration'],
  ...
  },
  {
    ...
    description:
      'Designing an inclusive platform that connects people with disabilities to accessible services and opportunities.',
  ...
  },
  {
    id: 'outcast',
    title: 'Outcast',
    subtitle: 'Creative Community App',
    description:
      'A mobile app connecting Ethiopian creatives\u2014musicians, artists, and designers\u2014for collaboration and showcasing work.',
    thumbnail: '/images/outcast-thumb.jpg',
    category: 'mobile-app',
    tags: ['Mobile App', 'Social', 'Community', 'Creative'],
    status: 'in-development',
  ...
  },
  {
    ...
    description:
      'A personal finance management app designed for the Ethiopian market with local currency and payment method support.',
    thumbnail: '/images/hisab-thumb.jpg',
    category: 'mobile-app',
    tags: ['Fintech', 'Mobile App', 'Ethiopian Market'],
    status: 'in-development',
  ...
  },
  {
    id: 'ideas-lab',
    title: 'Ideas Lab',
    subtitle: 'Innovation Workshop Site',
    description:
      'A Framer-built website for an innovation workshop focused on Ethiopian tech entrepreneurs and startups.',
    thumbnail: '/images/ideas-lab-thumb.jpg',
    category: 'framer',
    tags: ['Framer', 'Landing Page', 'No-code', 'Startup'],
    status: 'live',
    duration: 'Aug 2025',
